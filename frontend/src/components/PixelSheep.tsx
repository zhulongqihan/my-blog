...
const PALETTE: Record<string, string> = {
  ...
  W: '#FAFAFA', // white — wool body
  C: '#E0E0E0', // light grey — wool curl detail
  F: '#8D6E63', // warm brown — face
  E: '#263238', // very dark — eyes
  N: '#EC407A', // pink — nose / mouth
  H: '#5D4037', // horn brown
  P: '#F8BBD0', // pink — inner ear
  T: '#BCAAA4', // tail
};

type SheepState = 'idle' | 'walk' | 'sleep' | 'play' | 'graze';

// ─── Sprite Frames (19 wide × 16 tall) ──────────
// H = horn, O = outline, F = face, E = eye, N = nose/mouth
// W = wool, C = curl detail, P = inner ear, T = tail
// Design: floppy ears hanging DOWN (sheep), small horns on top, big fluffy wool body
